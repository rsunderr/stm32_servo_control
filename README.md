...
- Implement the code from servo_fxns in main.c (as seen in main_config.png):
    - #include "servo_fxns.h" at the top under /* USER CODE BEGIN Includes */
    - HAL_TIM_PWM_Start(&htim2, TIM_CHANNEL_1); to start TIM2 under /* USER CODE BEGIN 2 */
    - rotate_ccw(); or rotate_cw(); to rotate servo in while under /* USER CODE BEGIN 3 */
